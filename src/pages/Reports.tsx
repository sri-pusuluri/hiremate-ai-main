...
export default function Reports() {
  ...
  return (
    <div className="p-4 sm:p-5 space-y-4 max-w-7xl mx-auto animate-fade-in print:p-0">
      {/* Top Actions Bar */}
      ...
      <div className="bg-card border border-border rounded-xl shadow-2xs overflow-hidden">
        <div className="px-4 py-2.5 border-b border-border flex items-center justify-between">
          <div>
            <h3 className="text-sm sm:text-base font-semibold text-foreground">Candidate Records & AI Evaluations</h3>
                        ...
                        <TableCell>
                          <div className="flex items-center gap-1 flex-wrap max-w-[260px]">
                            {c.matchedSkills.slice(0, 3).map(skill => (
                              <span key={skill} className="px-1.5 py-0.5 bg-emerald-50 text-emerald-700 dark:bg-emerald-950/40 dark:text-emerald-300 text-[10px] rounded font-medium whitespace-nowrap">
                                {skill}
                              </span>
                            ))}
                            ...
                            {c.matchedSkills.length === 0 && (
                              <span className="text-[10px] text-muted-foreground italic whitespace-nowrap">No core matches</span>
                            )}
                          </div>
                        </TableCell>
