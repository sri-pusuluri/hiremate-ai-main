  ...
  switch (type) {
    case 'poor-jd':
      return {
        ...
        description: 'Sahab Portal AI works best with detailed job descriptions. The current JD may not provide enough context for accurate ranking.',
    ...
    case 'ai-unavailable':
      return {
        ...
        description: 'Sahab Portal AI is temporarily unavailable. You can continue reviewing candidates manually.',
