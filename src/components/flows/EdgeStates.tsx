  ...
  switch (type) {
    case 'poor-jd':
      return {
        ...
        description: 'HireSortAi works best with detailed job descriptions. The current JD may not provide enough context for accurate ranking.',
    ...
    case 'ai-unavailable':
      return {
        ...
        description: 'HireSortAi is temporarily unavailable. You can continue reviewing candidates manually.',
